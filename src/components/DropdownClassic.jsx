...
function DropdownClassic({ onFilterChange }) {
  const options = [
    {
      id: 0,
      period: 'Hôm nay',
  ...
  return (
    <div className='relative inline-flex'>
      <button
        ref={trigger}
        className='justify-between bg-white btn min-w-44 border-slate-200 hover:border-slate-300 text-slate-500 hover:text-slate-600'
      ...
      >
        ...
        <svg
          className='ml-1 fill-current shrink-0 text-slate-400'
          width='11'
          height='7'
          viewBox='0 0 11 7'
        >
            ...
            return (
              <button
                ...
                onClick={() => {
                  ...
                  if (!onFilterChange()) onFilterChange(option.id);
                  setDropdownOpen(false);
                }}
              >
                <svg
